 ...
 * Expects HRPermissions helper (autoloaded).
 */
$matrixSections = \App\Helpers\HRPermissions::pageMatrixSections();
$matrixLabels = \App\Helpers\HRPermissions::pageMatrixLabels();
...
<?php
    foreach ($pageKeys as $pageKey):
        ...
        $isAdminOnly = in_array($pageKey, [], true);
        $inheritsView = \App\Helpers\HRPermissions::pageInheritsView($pageKey);
        $viewParentKey = $inheritsView ? (\App\Helpers\HRPermissions::pagePermissionParent()[$pageKey] ?? null) : null;
...
<?php
        foreach ($actionCaps as $col):
            $cap = \App\Helpers\HRPermissions::matrixColumnCapability($pageKey, $col);
...
<?php
                ...
                $capLabel = \App\Helpers\HRPermissions::matrixCapabilityLabel($cap);
?>
                        <td class="text-center">
