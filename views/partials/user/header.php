...
Middleware::protectModule(['Employee']);
$hrmJs = View::jsConfig();
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
	...
	<base href="<?= View::e((defined('BASE_URL') ? BASE_URL : '') . '/user/') ?>">
	<!-- Google Fonts -->
	<link rel="preconnect" href="https://fonts.googleapis.com">
	<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
	<link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet">
	<link rel="stylesheet" href="<?= View::asset('css/user/style.css') ?>?v=<?= time() ?>">
	<?php if (!empty($load_apexcharts)): ?>
		<!-- ApexCharts (dashboard only — set $load_apexcharts before including this file) -->
