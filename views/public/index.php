    ...
    <div class="auth-v2-shell">
        <section class="auth-v2-hero" aria-label="Welcome">
            ...
            <div class="auth-v2-hero__layout">
                <a class="auth-v2-hero__logo" href="index.php" aria-label="Company home">
        ...
        <div class="auth-v2-aside">
            <div class="auth-v2-card" id="account-login">
                ...
                <form method="post" action="" autocomplete="on" novalidate>
                    ...
                    <div class="remember-me-v2" style="display: flex; align-items: center; gap: 8px; margin-bottom: 24px; margin-top: -8px;">
                        <input type="checkbox" id="remember" name="remember" style="width: 16px; height: 16px; accent-color: var(--primary-color); cursor: pointer;">
                        <label for="remember" style="font-size: 13px; color: var(--login-muted); cursor: pointer; user-select: none; font-weight: 500;">Keep me logged in</label>
                    </div>
