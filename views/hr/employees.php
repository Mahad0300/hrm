...
<div class="modal-overlay" id="addEmployeeModal">
    <div class="modal-content premium wide-md">
        ...
        <div class="modal-body p-30">
            ...
            <form id="addEmployeeForm" method="POST" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="form-grid-2">
                        <div class="form-group">
                            ...
                            <input type="email" id="add_email" name="email" class="form-control bg-white-input"
                                placeholder="email@company.com" autocomplete="off" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="password-input-container">
                                <input type="password" name="password" class="form-control bg-white-input"
                                    id="add_password" placeholder="••••••••" autocomplete="new-password" required>
                ...
                <div class="step-pane" id="step2">
                    ...
                    <div class="form-grid-2">
                        ...
                        <div class="form-group">
                            ...
                            <select id="add_role" name="role" class="form-control bg-white-input" required>
                        ...
                        <div class="form-grid-3">
                            ...
                            <div class="form-group">
                                ...
                                <select id="add_account_type" name="account_type" class="form-control bg-white-input" required>
                                    ...
                                    <option value="IBFT number">IBFT number</option>
...
<div class="modal-overlay" id="editEmployeeModal">
    <div class="modal-content premium wide-md">
        ...
        <div class="modal-body p-30">
            ...
            <form id="editEmployeeForm" method="POST" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="step-pane">
                    ...
                    <div class="form-grid-2">
                        ...
                        <div class="form-group">
                            <label class="admin-form-label">System Role *</label>
                            <select id="edit_role" name="role" class="form-control bg-white-input" required>
                                <option value="Employee">Employee</option>
                                <option value="HR">HR</option>
                                <option value="Admin">Admin</option>
                            </select>
                ...
                <div class="step-pane">
                    ...
                    <div class="form-grid-3 mt-10">
                        <div class="form-group">
                            <label class="admin-form-label">Resume Attachment</label>
                            <div class="custom-file-upload">
                                <label for="edit_resume_upload" class="file-upload-wrapper"
                                    id="edit_resume_wrapper">
                                    <i data-lucide="file-text" size="20"></i>
                                    <span class="file-upload-label" id="edit_resume_filename">Choose Resume</span>
                                    <span class="file-upload-info">PDF, DOCX up to 5MB</span>
                                </label>
                        ...
                        <div class="form-group">
                            <label class="admin-form-label">ID Card Attachment</label>
                            <div class="custom-file-upload">
                                <label for="edit_id_upload" class="file-upload-wrapper" id="edit_id_wrapper">
                                    <i data-lucide="image" size="20"></i>
                                    <span class="file-upload-label" id="edit_id_filename">Upload ID Card</span>
    ...
    <div class="modal-content premium">
        ...
        <form id="quickShiftForm" autocomplete="off">
            ...
            <div class="modal-footer flex-between p-20 border-top">
                <button type="button" class="btn-primary no-bg border text-light" onclick="closeQuickShiftModal()">Cancel</button>
...
<div class="modal-overlay" id="quickSalaryModal">
    <div class="modal-content premium">
        ...
        <form id="quickSalaryForm" autocomplete="off">
            ...
            <div class="modal-footer flex-between p-20 border-top">
                <button type="button" class="btn-primary no-bg border text-light" onclick="closeQuickSalaryModal()">Cancel</button>
