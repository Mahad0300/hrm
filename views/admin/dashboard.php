...
<div class="stat-grid mb-20">
    <a href="<?= \App\Core\View::to('employees') ?>" class="card stat-card stat-card--link" aria-label="Total Employees — open Employees">
    ...
    <a href="<?= \App\Core\View::to('attendance') ?>" class="card stat-card stat-card--link" aria-label="Present Today — open Attendance">
        <div class="stat-header">
    ...
    <a href="<?= \App\Core\View::to('leave') ?>" class="card stat-card stat-card--link"
    ...
    <a href="<?= \App\Core\View::to('recruitment') ?>" class="card stat-card stat-card--link"
    ...
    <a href="<?= \App\Core\View::to('events') ?>" class="card stat-card stat-card--link"
...
<section class="dashboard-section" aria-label="Organization snapshot">
    ...
    <div class="dashboard-snapshot-grid">
        <a href="<?= \App\Core\View::to('kpi') ?>" class="snapshot-tile snapshot-tile--primary">
        ...
        <a href="<?= \App\Core\View::to('notifications') ?>" class="snapshot-tile snapshot-tile--warning">
        ...
        <a href="<?= \App\Core\View::to('shifts') ?>" class="snapshot-tile snapshot-tile--neutral">
        ...
        <a href="<?= \App\Core\View::to('departments') ?>" class="snapshot-tile snapshot-tile--info">
        ...
        <a href="<?= \App\Core\View::to('hierarchy') ?>" class="snapshot-tile snapshot-tile--info">
        ...
        <a href="<?= \App\Core\View::to('jobs') ?>" class="snapshot-tile snapshot-tile--primary">
...
<section class="dashboard-section" aria-label="Needs attention">
    ...
    <div class="attention-grid">
        <a href="<?= \App\Core\View::to('leave') ?>" class="attention-card attention-card-warning">
        ...
        <a href="<?= \App\Core\View::to('recruitment') ?>" class="attention-card attention-card-primary">
        ...
        <a href="<?= \App\Core\View::to('recruitment.interviews') ?>" class="attention-card attention-card-info">
        ...
        <a href="<?= \App\Core\View::to('payroll') ?>" class="attention-card attention-card-neutral">
    ...
    <div class="dashboard-widgets-2 dash-ent-widgets">
        <article class="card dash-ent-card dash-ent-card--payroll">
            ...
            <footer class="dash-ent-card__foot">
                ...
                <a href="<?= \App\Core\View::to('payroll') ?>" class="dash-ent-btn">
        ...
        <article class="card dash-ent-card dash-ent-card--workforce">
            ...
            <footer class="dash-ent-card__foot">
                ...
                <a href="<?= \App\Core\View::to('employees') ?>" class="dash-ent-btn dash-ent-btn--ghost">
    ...
    <div class="dashboard-widgets-3">
        <div class="card dashboard-chart-card dash-feed-card">
            <div class="card-header-v2 card-header-v2--compact mb-0">
                ...
                <a href="<?= \App\Core\View::to('new-joining') ?>" class="dash-feed-link">View all</a>
            </div>
        ...
        <div class="card dashboard-chart-card dash-feed-card">
            <div class="card-header-v2 card-header-v2--compact mb-0">
                ...
                <a href="<?= \App\Core\View::to('announcements') ?>" class="dash-feed-link">Manage</a>
            </div>
        ...
        <div class="card dashboard-chart-card dash-feed-card">
            <div class="card-header-v2 card-header-v2--compact mb-0">
                ...
                <a href="<?= \App\Core\View::to('notifications') ?>" class="dash-feed-link">Inbox</a>
            </div>
    ...
    <div class="dashboard-widgets-2">
        <div class="card dashboard-chart-card">
            <div class="card-header-v2 card-header-v2--compact">
                ...
                <a href="<?= \App\Core\View::to('kpi') ?>" class="dash-feed-link">KPI hub</a>
            </div>
        ...
        <div class="card dashboard-chart-card dash-hierarchy-card">
            ...
            <div class="dash-hierarchy-body">
                ...
                <div class="dash-org-actions">
                    <a href="<?= \App\Core\View::to('hierarchy') ?>" class="dash-org-btn dash-org-btn--primary">
                    ...
                    <a href="<?= \App\Core\View::to('departments') ?>" class="dash-org-btn dash-org-btn--secondary">
...
<script src="<?= \App\Core\View::asset('js/admin/dashboard.js') ?>"></script>
