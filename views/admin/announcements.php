...
<div class="modal-overlay" id="viewAnnouncementModal">
    <div class="modal-content wide-md">
        ...
        <div class="modal-footer flex-between">
            <div class="flex-center gap-10">
                <img id="view_ann_author_img" src="<?= \App\Core\View::image('profile-image/default-avatar.svg') ?>" class="icon-box-sm">
...
<!-- Announcement Logic -->
<script src="<?= \App\Core\View::asset('js/shared/announcements.js') ?>"></script>
