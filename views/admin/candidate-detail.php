...
<div class="cand-v2-container">
    ...
    <div class="flex-between mb-24 px-8">
        <div class="flex-center gap-16">
            ...
            <a href="<?= View::to('recruitment') ?>" class="action-btn no-bg border" title="Back to Candidate Pool">
...
<script src="<?= \App\Core\View::asset('js/admin/candidate-detail.js?v=6') ?>"></script>
