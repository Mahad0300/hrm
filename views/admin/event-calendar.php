...
<!-- Add Calendar Styles -->
<link rel="stylesheet" href="<?= \App\Core\View::asset('css/admin/calendar.css') ?>">
    ...
    <div class="calendar-main">
        <div class="calendar-header">
            <div class="calendar-nav" style="display: flex; align-items: center; gap: 12px;">
                ...
                <button type="button" class="btn-primary border" id="todayBtn">Today</button>
                <div class="btn-group">
...
<script src="<?= \App\Core\View::asset('js/admin/calendar.js?v=1.0.1') ?>"></script>
