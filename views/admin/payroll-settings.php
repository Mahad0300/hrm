                ...
                <div class="highlight-box bg-primary-light border-primary-light mb-24">
                    <div class="flex-center gap-12">
                        ...
                        <p class="font-13 text-dark leading-relaxed">
                            <?php
                            $sDay = \App\Helpers\PayrollConfig::getStartDay($pdo);
                            $eDay = \App\Helpers\PayrollConfig::getEndDay($pdo);
                            ?>
                            Currently, your payroll cycle is set <?= ($sDay > $eDay) ? "from the <strong>{$sDay}th</strong> of the previous month to the <strong>{$eDay}th</strong> of the current month." : "from the <strong>{$sDay}st</strong> to the <strong>{$eDay}th</strong> of the current month." ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-with-icon">
                            ...
                            <input type="number" name="start_day" class="form-control bg-white-input pl-45" 
                                   value="<?= \App\Helpers\PayrollConfig::getStartDay($pdo) ?>" min="1" max="31" required>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-with-icon">
                            ...
                            <input type="number" name="end_day" class="form-control bg-white-input pl-45" 
                                   value="<?= \App\Helpers\PayrollConfig::getEndDay($pdo) ?>" min="1" max="31" required>
                        </div>
