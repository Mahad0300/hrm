        ...
        <div class="flex-between align-start w-full">
            <div class="greeting-area">
                <div class="flex-center gap-12 mb-8">
                    <a href="<?= View::url('dashboard') ?>" class="action-btn no-bg border" title="Back to Dashboard">
            ...
            <div class="profile-aside">
                <div class="premium-card profile-identity-card flex-column flex-center text-center mb-24">
                    <div class="profile-avatar-wrapper mb-20">
                        <img id="profileAvatarImg" src="<?= View::image('profile-image/default-avatar.svg') ?>"
                            class="profile-avatar-xl shadow-lg" alt="Profile photo"
                            data-default-avatar="<?= View::image('profile-image/default-avatar.svg') ?>"
...
<script src="<?= \App\Core\View::asset('js/user/profile.js') ?>"></script>
