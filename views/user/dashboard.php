...
<header class="dashboard-greeting mb-25">
    <div class="greeting-content">
        <h2 class="font-700 mb-5">Welcome back, <span class="text-primary"><?php echo htmlspecialchars($_SESSION['user_name'] ?? 'User', ENT_QUOTES, 'UTF-8'); ?></span></h2>
...
<section class="udash-stat-grid">
    <a href="<?= \App\Core\View::url('daily-attendance') ?>" class="card-link">
    ...
    <a href="<?= \App\Core\View::url('leave') ?>" class="card-link">
        <article class="card stat-card">
            <div class="stat-header">
    ...
    <a href="<?= \App\Core\View::url('hierarchy') ?>" class="card-link">
        <article class="card stat-card">
            <div class="stat-header">
    ...
    <a href="<?= \App\Core\View::url('notifications') ?>" class="card-link">
        <article class="card stat-card">
            <div class="stat-header">
...
<section class="udash-grid">
    <article class="card udash-panel">
        <div class="udash-head">
            ...
            <a href="<?= \App\Core\View::url('daily-attendance') ?>" class="font-13 text-light">Open details</a>
        </div>
...
<section class="udash-grid udash-grid--secondary">
    <article class="card udash-panel h-full">
        <div class="udash-head align-start">
            ...
            <a href="<?= \App\Core\View::url('leave') ?>" class="font-13 text-light hover-underline">Open leave history</a>
        </div>
    ...
    <article class="card udash-panel">
        <div class="udash-head">
            ...
            <a href="<?= \App\Core\View::url('daily-attendance') ?>" class="font-13 text-light">Open timesheet</a>
        </div>
...
<section class="udash-grid udash-grid--secondary">
    <article class="card udash-panel">
        <div class="udash-head">
            ...
            <a href="<?= \App\Core\View::url('announcements') ?>" class="font-13 text-light">View all</a>
        </div>
    ...
    <article class="card udash-panel">
        <div class="udash-head">
            ...
            <a href="<?= \App\Core\View::url('notifications') ?>" class="font-13 text-light">Open inbox</a>
        </div>
...
<script src="<?= \App\Core\View::asset('js/user/dashboard.js') ?>"></script>
