            ...
            <tbody id="payrollTableBody">
                <?php if ($payroll_row_count > 0): ?>
                    ...
                    <tr>
                        ...
                        <td><?= (int) ($row['absents_count'] ?? $row['leaves_count']) ?></td>
                        ...
                        <td class="text-center">
                            <div class="btn-group justify-center">
                                <button type="button" onclick="window.open('<?= $prefix ?>/user/payslip/print?month=<?= htmlspecialchars($row['month_year']) ?>&name=<?= $urlName ?>', '_blank')" class="action-btn action-btn-view" title="View payslip">
...
<script src="<?= \App\Core\View::asset('js/user/payroll.js') ?>"></script>
