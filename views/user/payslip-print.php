...
if (!\App\Core\Auth::isLoggedIn() || $_SESSION['user_role'] !== 'Employee') {
...
if (function_exists('logActivity')) {
    logActivity($_SESSION['user_id'], "Exported Payslip", "Payroll", "Employee $fullName exported/printed their payslip for month $formattedMonth.");
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    <div class="no-print" style="display: flex; gap: 10px;">
        ...
        <a href="<?= View::url('payroll') ?>" class="no-print-btn" style="background: #e2e8f0; color: #333;">Back</a>
    </div>
