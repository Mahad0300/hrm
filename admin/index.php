    ...
    <div class="dashboard-widgets-3">
        ...
        <div class="card dashboard-chart-card dash-payroll-card">
            ...
            <div class="dash-payroll-body">
                ...
                <div class="dash-progress-track" role="progressbar" aria-valuenow="82" aria-valuemin="0"
                    aria-valuemax="100">
                ...
                <dl class="dash-payroll-dl">
                    ...
                    <div>
                        <dt>Variance</dt>
                        <dd class="text-success">−PKR 1.2M</dd>
                    </div>
                </dl>
                <p class="font-12 text-light mt-10 mb-0">Next run · 28 Mar — <a href="payroll.php"
                        class="dash-inline-link">Open payroll</a></p>
            </div>
        </div>
        <div class="card dashboard-chart-card">
            <div class="card-header-v2 card-header-v2--compact">
                <div>
                    ...
                    <p class="dashboard-chart-sub">Share of headcount — on time, late, half day &amp; absent (sample)
                    </p>
                </div>
            </div>
            <div class="dash-punctuality-radial-wrap" id="punctualityRadialWrap">
                <div id="adminPunctualityChart" class="admin-apex-chart" style="min-height:260px;" role="img"
                    aria-label="Today punctuality breakdown"></div>
            </div>
        </div>
    </div>
</section>
