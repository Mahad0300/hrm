...
<head>
    ...
    <title>Payslip - <?= $data['first_name'] . ' ' . $data['last_name'] ?></title>
    <style>
        ...
        .no-print-btn { background: #007bff; color: #fff; padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer; margin-bottom: 20px; display: block; width: 120px; text-align: center; text-decoration: none; }
...
<body>
    <div class="no-print" style="display: flex; gap: 10px;">
        ...
        <a href="payroll.php" class="no-print-btn" style="background: #6c757d;">Back</a>
    </div>
