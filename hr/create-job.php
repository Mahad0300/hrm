        ...
        <div class="card-body p-30">
            <form id="createJobForm">
                ...
                <div class="form-group mb-30">
                    ...
                    <textarea id="jobDesc" class="form-control bg-white-input" rows="6" placeholder="Describe the responsibilities, requirements, and benefits..." required></textarea>
                </div>
                ...
                <div class="form-builder-section pt-30 border-top mt-30">
                    <div class="mb-20">
                        ...
                        <p class="font-12 text-light mt-1">Configure the questions candidates must answer during application</p>
                    </div>
                    ...
                    <div class="flex align-center gap-20 mb-30">
                        ...
                        <div class="quick-add-chips">
                            <button type="button" class="chip-btn" onclick="quickAddQuestion('What is your current salary?')">+ Salary</button>
                            <button type="button" class="chip-btn" onclick="quickAddQuestion('How many years of experience do you have?')">+ Experience</button>
                            <button type="button" class="chip-btn" onclick="quickAddQuestion('Portfolio Link')">+ Portfolio</button>
                            <button type="button" class="chip-btn" onclick="quickAddQuestion('LinkedIn Profile')">+ LinkedIn</button>
                            <button type="button" class="chip-btn" onclick="quickAddQuestion('When can you start?')">+ Start Date</button>
                        </div>
                    </div>
                ...
                <div class="flex-end gap-12 mt-40">
                    <button type="button" class="btn-primary no-bg border text-light px-30" onclick="window.history.back()">
