...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if (isset($_FILES['document']) && $_FILES['document']['error'] === UPLOAD_ERR_OK) {
            ...
            \App\Helpers\StorageHelper::ensureDirectory('uploads/leaves/');
            $destination = \App\Helpers\StorageHelper::diskPath('uploads/leaves/' . $filename);
        ...
        if ($action === 'edit' && !empty($leave_id)) {
            ...
            \App\Helpers\WebSocketHelper::broadcast('leaves_updated');
