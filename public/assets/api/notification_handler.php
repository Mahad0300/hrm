...
if (!function_exists('addNotification')) {
    function addNotification($recipient_ids, $title, $message, $target_url = null, $type = 'System', $sender_id = null) {
        ...
        try {
            ...
            \App\Helpers\WebSocketHelper::sendToUsers($recipient_ids, 'notification', [
                'title' => $title,
                'message' => $message,
...
// ΓöÇΓöÇΓöÇ API Endpoint (Only runs when called directly via HTTP) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
if (basename($_SERVER['SCRIPT_FILENAME']) !== basename(__FILE__)) {
    return; // File was included via require_once ΓÇö stop here, function already loaded
}
...
// unread_count is a silent sidebar poll ΓÇö not a page action
    ...
    switch ($action) {
        ...
        case 'mark_read':
            ...
            if ($id) {
                ...
                \App\Helpers\WebSocketHelper::sendToUser((int)$user_id, 'notification');
