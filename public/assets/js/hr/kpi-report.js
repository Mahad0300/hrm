...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (!empId) {
        Swal.fire('Error', 'No employee ID or name slug provided.', 'error').then(() => {
...
function renderProfile(emp) {
    ...
    document.getElementById('detailAvatar').src = emp.profile_pic ? '../' + emp.profile_pic : '../assets/images/profile-image/default-avatar.svg';
}
...
window.refreshKpiReport = function() {
    if (currentEmpId) {
        fetchReportData(currentEmpId);
    }
};
