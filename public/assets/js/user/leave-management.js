...
function closeLeaveFormModal(formId) {
    var modalId = (formId === 'editLeaveForm') ? 'editLeaveModal' : 'applyLeaveModal';
...
function openApplyLeaveModal() {
    if (window.LEAVE_TYPES_AVAILABLE === false) {
        Swal.fire({
            icon: 'warning',
            title: 'Leave Not Available',
            text: 'Leave settings have not been configured by HR yet. Please contact your administrator.',
            heightAuto: false
        });
        return;
    }
