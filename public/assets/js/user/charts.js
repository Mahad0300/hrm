...
(function () {
    ...
    async function initApexDashboardCharts() {
        ...
        try {
            const response = await fetch('/assets/api/stats_handler.php?action=get_chart_data');
    ...
    async function fetchLeaveAnalytics(from, to) {
        try {
            const res = await fetch(`/assets/api/stats_handler.php?action=get_leave_analytics&from=${from}&to=${to}`);
