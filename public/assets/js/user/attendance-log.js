...
document.addEventListener('DOMContentLoaded', function () {
    ...
    window.fetchLogs = function() {
        ...
        fetch(window.HRM.api(`attendance_handler.php?action=fetch_logs&month=${month}`))
            .then(res => res.json())
            .then(res => {
...
window.openAttendanceModal = function(data) {
    ...
    if (dateEl) {
        ...
        dateEl.dataset.rawDate = data.rawDate || data.date || '';
    }
...
window.saveAttendanceDetails = function() {
    ...
    const payload = {
        date: dateEl.dataset.rawDate || dateEl.textContent.trim(),
    ...
    fetch(window.HRM.api('attendance_handler.php?action=save_message'), {
        method: 'POST',
