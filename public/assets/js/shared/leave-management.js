(function () {
    ...
    function initLeaveSettings() {
        ...
        if (openBtn && !openBtn.dataset.boundLeaveSettings) {
            openBtn.dataset.boundLeaveSettings = 'true';
        ...
        if (saveBtn && !saveBtn.dataset.boundLeaveQuotaSave) {
            saveBtn.dataset.boundLeaveQuotaSave = 'true';
    ...
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLeaveSettings);
    } else {
        initLeaveSettings();
    }
})();
...
function openLeaveDetailModal(leaveId, empName, leaveType, days, fromDate, toDate, adminComment, docUrl, docType, status, reason) {
